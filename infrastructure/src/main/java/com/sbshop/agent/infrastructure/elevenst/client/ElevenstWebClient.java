package com.sbshop.agent.infrastructure.elevenst.client;

import com.sbshop.agent.infrastructure.elevenst.config.ElevenstProperties;
...
public class ElevenstWebClient {
