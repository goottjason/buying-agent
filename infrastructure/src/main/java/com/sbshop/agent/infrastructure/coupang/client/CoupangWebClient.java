package com.sbshop.agent.infrastructure.coupang.client;

import com.sbshop.agent.infrastructure.coupang.config.CoupangProperties;
...
// HMAC 생성을 위한 자바 내장 라이브러리들 (기존 CoupangApiUtil에 있던 내용)
...
public class CoupangWebClient {
  ...
  private String generateHmacSignature(String method, String path) {
    try {
      ...
      SecretKeySpec secretKeySpec = new SecretKeySpec(properties.getSecretKey().getBytes(StandardCharsets.UTF_8), "HmacSHA256");
