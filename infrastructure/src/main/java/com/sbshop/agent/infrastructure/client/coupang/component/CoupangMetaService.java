...
public class CoupangMetaService {
  ...
  public CategoryMetaResult getCategoryMeta(Long categoryId) throws Exception {
    ...
    List<Attribute> attributes = extractMandatoryAttributes(dataNode);
      ...
      if ("MANDATORY".equals(attr.path("basicRequired").asText())) {
        ...
        if ("NUMBER".equals(dataType)) {
          ...
          if (unitsNode.isArray() && !unitsNode.isEmpty()) {
            String matchedUnit = findProperUnit(unitsNode, product.getUnit());
